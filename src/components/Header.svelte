...
<header class={'sticky z-[10] mt-1 top-0 duration-200 px-6 flex items-center justify-between border-b border-solid' + (
    y > 0 
        ? 'py-4 bg-slate-950 border-violet-950' 
        : 'py-6 bg-transparent border-transparent'
)}>
    <h1 class="font-medium">
        <b class="font-bold poppins">David</b> Battye
    </h1>
    ...
    <a 
        ...
        target="_blank"
        class="blueShadow rleative overflow-hidden px-5 py-2 group rounded-full bg-white text-slate-950">
